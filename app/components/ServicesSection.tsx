...
const ServicesSection = () => {
  ...
  const serviceCards = [
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-gray-700 group-hover:text-white transition-colors duration-300" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="mb-16">
              ...
              >
                <div className="flex flex-col items-start gap-2">
                  ...
                  <h3 className="text-sm sm:text-base font-medium text-gray-600">Services</h3>
                  <div className="h-[2px] w-12 bg-black"></div>
                </div>
                
                <h2 className="text-2xl sm:text-[2.75rem] font-bold text-[#1e293b] mt-4 sm:mt-6 mb-4 sm:mb-6">Your Best Possible Solutions</h2>
              ...
              {serviceCards.map((card, index) => (
                ...
                >
                  <div className="p-6">
                    ...
                    <h3 className="text-lg font-semibold mb-3 text-black">{card.title}</h3>
                ...
                {serviceCards.map((_, index) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full transition-all duration-300 ${
                      currentSlide === index ? 'bg-gray-800 w-4' : 'bg-gray-400'
                    }`}
