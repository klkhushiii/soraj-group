...
const TestimonialSection = () => {
  ...
  const handleImageError = (e: React.SyntheticEvent<HTMLImageElement, Event>) => {
    e.currentTarget.src = '/images/fallback-image.jpg'; // Add a fallback image
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-12">
          ...
          <div className="md:hidden flex flex-col gap-6">
            <AnimatePresence mode="wait">
              <motion.div
                key={testimonials[currentIndex].id + "-mobile"}
              ...
              >
                ...
                <motion.p 
                  ...
                  className="text-gray-600 text-sm mb-4 leading-relaxed italic"
                >
                ...
                >
                  ...
                  <div>
                    <h4 className="font-semibold text-[#1e3a8a] text-base">
            ...
            <div className="relative w-full h-[300px] rounded-2xl overflow-hidden shadow-lg">
              <AnimatePresence mode="wait">
                <motion.div
                  key={testimonials[currentIndex].id + "-mobile-image"}
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                ...
                >
                  <Image
                    ...
                    alt={`Property view by ${testimonials[currentIndex].author}`}
                    fill
